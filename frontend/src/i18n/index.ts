...
export const dict: Dict = {
  ...
  setting_deadline_calendar_enabled_hint: {
    ru: 'Влияет только на дедлайн этапа (норматив часов): в выходные, праздники и ночью время этапа не идёт — в том числе после паузы и возврата на предыдущий этап. Общий дедлайн проекта задаётся вручную и не пересчитывается.',
    uz: "Faqat bosqich dedlayniga ta'sir qiladi (soat normativi): dam kunlari, bayramlarda va tunda bosqich vaqti ketmaydi — pauzadan keyin va orqaga qaytarilganda ham. Proyektning umumiy dedlayni qo'lda kiritiladi va qayta hisoblanmaydi.",
  },
  setting_work_days: { ru: 'Рабочие дни недели', uz: 'Haftaning ish kunlari' },
  setting_work_hours: { ru: 'Рабочие часы', uz: 'Ish vaqti' },
  wc_time_stopped: { ru: 'Время этапов остановлено', uz: "Bosqich vaqti to'xtagan" },
  wc_weekend: { ru: 'выходной', uz: 'dam kuni' },
  wc_holiday: { ru: 'праздник', uz: 'bayram' },
  wc_offhours: { ru: 'нерабочее время', uz: 'ish vaqtidan tashqari' },
  wc_resumes: { ru: 'продолжится', uz: 'davom etadi' },
  wc_work_time_left: { ru: 'Осталось рабочего времени', uz: "Qolgan ish vaqti" },
  ...
  control_enabled: { ru: 'Требовать контроль перед переходом', uz: 'O‘tishdan oldin control talab qilish' },
  control_pause_deadline: { ru: 'Останавливать дедлайн во время контроля', uz: 'Control paytida dedlaynni to‘xtatish' },
  control: { ru: 'Контроль', uz: 'Control' },
  control_stages: { ru: 'Может контролировать этапы', uz: 'Control qila oladigan bosqichlar' },
  control_send: { ru: 'Отправить на контроль', uz: 'Control uchun yuborish' },
  control_choose_controller: { ru: 'Кто будет контролировать', uz: 'Kim control qiladi' },
  control_comment: { ru: 'Комментарий', uz: 'Izoh' },
  control_pending: { ru: 'На контроле', uz: 'Controlda' },
  control_approve: { ru: 'Подтвердить', uz: 'Tasdiqlash' },
  control_reject: { ru: 'Отклонить', uz: 'Rad etish' },
  control_reject_reason: { ru: 'Причина отклонения', uz: 'Rad etish sababi' },
  control_history: { ru: 'История контроля', uz: 'Control tarixi' },
  control_color: { ru: 'Цвет проекта на контроле', uz: 'Control holatidagi rang' },
  control_filter: { ru: 'На контроле', uz: 'Controlda' },
